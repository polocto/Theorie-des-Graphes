...
void Graph::calcule_indices()
{
    ...
    calc_icd();
    std::cout << "Degres ok" << std::endl;
    calc_vect_propre();
    std::cout << "Vecteur Propre ok" << std::endl;
    //calc_icp();
    std::cout << "Centralite de Proximite ok" << std::endl;
    Brand();
    std::cout << "Brande ok" << std::endl;
    calc_ici_naif();
    std::cout << "Naif ok" << std::endl;
    calc_indice_total();
    std::cout << "Total ok" << std::endl;
...
void Graph::calc_indice_total()
{
    ...
    m_indice=total/((double)((double)m_sommets.size()* (double)m_sommets.size())+3* (double)m_sommets.size()+2)/(2* (double)m_sommets.size()-3);
}
